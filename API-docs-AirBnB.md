...
* Request
  * Method: `GET`
  * URL: `/users/:userId/reviews-submitted`
  * Body: none
...
* Request
  * Method: `GET`
  * URL: `/spots/filtered` // maybe delete /filtered because this is just the first requent but more specific?
  * Query Parameters
